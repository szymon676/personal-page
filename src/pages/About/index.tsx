...
export const About = () => {
  return (
    ...
    >
      <div 
       className="px-10 pb-12 md:w-[400px] md:h-[300px] md:p-0 bg-gradient-to-br from-black to-neutral-900   rounded-lg">
        ...
        <div className="md:ml-8 mt-8 text-white text-base">
          ...
          <br />
          <p>My hobby is programming, mainly Backend development.</p>
          <br />
          <p>I love working in team and learning new technologies</p>
        </div>
      </div>
